<template>
  	<div class="table-view ozn-component" :class="cssStyle">
	    <table class="ozn-table">
	      	<thead>
		        <tr>
		          	<th v-for="(col, idx) in headers" :key="idx" @click="sortBy(idx)">
...
export default {
  ...
  computed: {
    sortOptions() {
      return Object.assign(this.sortDefault, this.sort) // props
    },
    paginationOptions() {
